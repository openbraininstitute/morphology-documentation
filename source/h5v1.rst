...
The attributes in the `/metadata` group are:
  ...
  - `cell_family_enum`: An H5 enum that can take the values NEURON, GLIA or
    SPINE. Inside each family there can be multiple types, this classification
  ...
  - `cell_family`: An H5 attribute of type `cell_family_enum`: States the
     ...
     is assumed to be NEURON. As of version 1.3, the cell family can be
     `SPINE`.
