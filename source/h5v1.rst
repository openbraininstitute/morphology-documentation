...
- Sections 0 and 1 belong to **Spine A**. Section 0 is the neck (type 2) and
  section 1 is the head (type 3). The shared point at the neck/head boundary
  (3., 3.) is duplicated as points i=2 and i=3.

- Sections 2, 3, and 4 belong to **Spine B**. Section 2 is the neck (type 2).
  Sections 3 and 4 are both heads (type 3) that branch from section 2
  (``PID = 2``), forming a bifurcation. The shared point at the bifurcation
  (5., 7.) is duplicated as points i=7, i=8, and i=10 (the last point of the
  neck and the first point of each head).
